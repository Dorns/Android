...
public class MainActivity extends AppCompatActivity {
    ...
    public void enviar(View v) {
        ...
        try {
            ...
            final String url = "http://10.0.2.2:8080/ImobiliariaWeb/ImobiliariaServlet";

            RequestQueue queue = Volley.newRequestQueue(this);
            ErroVolley erro = new ErroVolley();
            RespostaVolley resp = new RespostaVolley();
            JsonObjectRequest req = new JsonObjectRequest(url, imovel,resp,erro);
            queue.add(req);
    ...
    private class ErroVolley implements Response.ErrorListener {
    ...
    private class RespostaVolley implements Response.Listener<JSONObject> {

        @Override
        public void onResponse(JSONObject response) {

            try {
                Log.i("RESPOSTA", response.getString("status"));
